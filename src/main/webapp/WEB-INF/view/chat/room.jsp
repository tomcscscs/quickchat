...
<title><i class="bi bi-rocket"></i>퀵챗</title>
<link
...
<body>
	...
	<nav class="navbar bg-body-tertiary sticky-top"
		...
		<div class="container-fluid">
			<a class="navbar-brand d-flex align-items-center"
				href="${contextPath}/chat/showLoginIndex"> <i
						...
						<c:otherwise>
							...
							<div>
								...
								<li class="nav-item"><a class="nav-link active"
									aria-current="page" href="${contextPath }/logout"><i
	...
	<div class="fixed-bottom input-group bg-dark"
		style="z-index: 9; border: 3px solid #fff; border-radius: 9px;">
